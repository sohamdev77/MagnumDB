...
Currently, MagnumDB is in active development (pre-1.0). Only the latest `main` branch and the most recent crates.io release are supported with security updates.
